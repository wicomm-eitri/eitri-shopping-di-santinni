...
export default function ProductCardFullImage(props) {
	...
	return (
		<View
			...
			className={`relative flex flex-col w-full h-full justify-between border-[0.5px] border-neutral-300 bg-white rounded ${className}`}>
			...
			<View className='flex flex-col w-full flex-1 px-2 pt-5 pb-4 gap-2'>
