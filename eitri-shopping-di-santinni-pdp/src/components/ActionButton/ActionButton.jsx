...
import { CustomButton, Loading, FloatNotification, BottomInset } from 'eitri-shopping-di-santinni-shared'
...
export default function ActionButton(props) {
	...
	return (
		<>
			<View className='fixed bottom-0 left-0 right-0 z-[100] bg-white border-t border-gray-300'>
				<View className='p-4 w-full flex items-center gap-2.5 justify-between'>
					<CustomButton
