	...
	return (
		<Page
			...
			<View className='p-4'>
				{isLogged && (
					<View
						className='my-6 p-4 border border-gray-200 rounded-lg flex items-center justify-between  hover:bg-gray-50'
				...
				<View className='p-4 flex items-center justify-between border-b border-neutral-300 mt-2 mb-8'>
					...
					<View
						...
						className={`w-9 h-5 rounded-full p-[2px] flex items-center  transition-colors ${notificationsEnabled ? 'bg-[#C8102E]' : 'bg-gray-300'}`}>
						<View
