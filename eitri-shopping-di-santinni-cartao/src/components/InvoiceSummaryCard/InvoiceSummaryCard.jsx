...
export default function InvoiceSummaryCard(props) {
	...
	return (
		<View className='flex flex-col justify-between h-[210px] px-6 pt-5 pb-[26px] rounded-[14px] bg-[#F8F9FA] shadow-[0px_4px_6px_0px_rgba(0,0,0,0.25)]'>
			<View className='flex flex-col'>
				<View className='flex flex-row items-start justify-between'>
					<View className='flex flex-col gap-[10px]'>
						<Text className='text-xs leading-6 text-[#8C8C8C] font-semibold'>
							{t('invoiceSummary.currentInvoice', 'Fatura atual')}
						</Text>
						...
						<View className='flex flex-row items-center gap-[6px]'>
							<Text className='text-xs leading-6 text-black'>
								{t('invoiceSummary.dueOn', 'Vence dia:')}
							</Text>
					...
					<View className='flex flex-row items-center h-[31px] gap-[2px] pl-[2px] pr-[3px] rounded-[4px] border border-[#FFC126]'>
						...
						<Text className='text-[10px] font-semibold leading-6 text-[#FFC126]'>
							{t('invoiceSummary.pending', 'Fatura Pendente')}
						</Text>
					</View>
				</View>
			</View>
			...
			<CustomButton
				label={t('invoiceSummary.seeInvoice', 'Ver fatura')}
